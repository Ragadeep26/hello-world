...
infile_csv = r'D:\Data\3Packages\Moniman\solver\plaxis2d\tubes\tubes_wm.csv'    # tubes from Wallman
dir_out = r'D:\Data\3Packages\Moniman\solver\plaxis2d\tubes\jsons'
...
for i_row, row in df.iterrows():
    ...
    if i_row >= 0:
        try:
            ...
            name_profile_i = profile_i_dict['Rohr'].replace('*', 'x')    # some W profiles have '*' in name
