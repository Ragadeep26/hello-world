...
cobbles_HS = [("MaterialName", "Cobbles"),
               ("Colour", 10676870),
               ("SoilModel", 4), #4 for Hardening Soil small-strain
...
with open("Cobbles_HSsmall.json", "w") as write_file:    
...
with open("Gravel_dense_HSsmall.json", "w") as write_file:    
...
with open("Gravel_medium_HSsmall.json", "w") as write_file:    
...
with open("Gravel_loose_HSsmall.json", "w") as write_file:    
...
with open("Sand_dense_HSsmall.json", "w") as write_file:    
...
with open("Sand_medium_HSsmall.json", "w") as write_file:    
...
with open("Sand_loose_HSsmall.json", "w") as write_file:    
...
with open("Silt_hard_HSsmall.json", "w") as write_file:    
...
with open("Silt_stiff_HSsmall.json", "w") as write_file:    
...
with open("Silt_firm_HSsmall.json", "w") as write_file:    
...
with open("Silt_soft_HSsmall.json", "w") as write_file:    
...
with open("Silt_very_soft_HSsmall.json", "w") as write_file:    
...
with open("Clay_hard_HSsmall.json", "w") as write_file:    
...
with open("Clay_stiff_HSsmall.json", "w") as write_file:    
    json.dump(clay_hard_HS, write_file)
...
with open("Clay_firm_HSsmall.json", "w") as write_file:    
...
with open("Clay_soft_HSsmall.json", "w") as write_file:    
...
with open("Clay_very_soft_HSsmall.json", "w") as write_file:    
...
with open("Fill_HSsmall.json", "w") as write_file:    
