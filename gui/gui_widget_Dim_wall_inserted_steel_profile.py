...
# Form implementation generated from reading ui file 'gui_widget_Dim_wall_inserted_steel_profile.ui'
#
...
"")
        ...
        self.gridLayout_2.addWidget(self.lineEdit, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_2, 0, 10, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groupBox_9, 1, 0, 1, 7)
        ...
        self.tableWidget_8 = QtWidgets.QTableWidget(self.groupBox_10)
        self.tableWidget_8.setObjectName("tableWidget_8")
        self.tableWidget_8.setColumnCount(0)
        self.tableWidget_8.setRowCount(0)
        self.tableWidget_8.horizontalHeader().setDefaultSectionSize(170)
        self.horizontalLayout_2.addWidget(self.tableWidget_8)
        self.gridLayout_2.addWidget(self.groupBox_10, 1, 7, 1, 4)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Dimensioning tool for steel profile inserted wall"))
        ...
        self.label_5.setText(_translate("Form", "RC wall cut-off level [mNN]"))
        ...
        self.groupBox_10.setTitle(_translate("Form", "Internal forces at cut-off of RC wall"))
