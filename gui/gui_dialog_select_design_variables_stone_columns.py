...
# Form implementation generated from reading ui file 'gui_dialog_select_design_variables_stone_columns.ui'
#
...
"QLabel{background-color:rgb(215, 215, 215);}")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Columns diameter  [m]"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Columns spacing  [m]"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Columns depth [m]"))
