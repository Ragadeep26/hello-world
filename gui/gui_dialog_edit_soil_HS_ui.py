...
# Form implementation generated from reading ui file 'gui_dialog_edit_soil_HS.ui'
#
...
"QLabel{background-color:rgb(215, 215, 215);}")
        ...
        self.gridLayout.addWidget(self.pushButton_2, 2, 11, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.checkBox, 1, 11, 1, 1)
