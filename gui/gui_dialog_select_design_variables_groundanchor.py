...
# Form implementation generated from reading ui file 'gui_dialog_select_design_variables_groundanchor.ui'
#
...
"QLabel{background-color:rgb(215, 215, 215);}")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Angle  [degr.]"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Free length [m]"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "Lspacing [m]"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", "F_prestress [kN]"))
