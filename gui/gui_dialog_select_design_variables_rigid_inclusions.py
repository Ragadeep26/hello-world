...
# Form implementation generated from reading ui file 'gui_dialog_select_design_variables_rigid_inclusions.ui'
#
...
"QLabel{background-color:rgb(215, 215, 215);}")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "FDC diameter Dc  [m]"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Square grid spacing a [m]"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "FDC length [m]"))
